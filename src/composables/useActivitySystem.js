...
const Coords3DActivity = defineAsyncComponent(() => import('../../w-activities/LPD_Coords3D.vue'))

// ── Vakgebonden activiteiten uit s-activities/ ────────────────────────────
// Natuurkunde en chemie. Deze map stond los van de app; hierdoor zijn ze
// bereikbaar vanuit lessen.
...
const CurveSketchingActivity  = defineAsyncComponent(() => import('../../s-activities/CurveSketchingActivity.vue'))
const ChemicalBondingActivity = defineAsyncComponent(() => import('../../s-activities/ChemicalBondingActivity.vue'))
const IonicBondingActivity    = defineAsyncComponent(() => import('../../s-activities/IonicBondingActivity.vue'))
const ReactionBalanceActivity = defineAsyncComponent(() => import('../../s-activities/ReactionBalanceActivity.vue'))
...
const COMPONENT_MAP = {
    ...
    curveSketching:   CurveSketchingActivity,

    // Chemie
    chemicalBonding:  ChemicalBondingActivity,
    ionicBonding:     IonicBondingActivity,
    reactionBalance:  ReactionBalanceActivity
}
