...
export function processMathText(text) {
    ...
    // Let's do it on the processed result — not the original text.
    // (Previously used `text` here which caused double KaTeX rendering.)
    return processTextOutsideMath(result);
}
