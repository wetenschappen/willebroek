 ...
 *
 * VAKKEN: physics · biology · chemistry · science · math
 *   `subject` moet exact overeenkomen met het vak in src/data/modules.js,
 *   anders klopt het thema (kleur, icoon, watermerk) niet.
 */

export default {

    // ─── 1. METADATA ────────────────────────────────────────────────────────────
    id: 'fys3-mXX-lXX-onderwerp',       // Exact de bestandsnaam, zonder .js
    ...
    // ─── 2. CONFIG ──────────────────────────────────────────────────────────────
    config: {
        groenCode: 'MXXLX',             // Code op het antwoordblad
        groenAntwoord: 'fysica',        // Wachtwoord voor de S-toets in presentaties
        masterCode: 'wetenschappen',    // Masterwachtwoord leraar
        classId: '3NWa',                // Sleutel in src/data/students.js
        textbook: 'Fysica 3 Module XX',
        // cursusLink: 'https://...',   // Optioneel: opent in de Toolbox
    },
    ...
    timeline: {
        ...
        stepB: {
            ...
            // extraActivities: optioneel. De "+ Extra Materiaal" knop verschijnt
            // altijd; dit vult de inhoud. Algemene types: mixedRetrieval,
            // dragDrop, categorySort, mathFillBlanks, hotspot.
            // extraActivities: [
    ...
    slidesA: [
        { layout: 'title', title: 'Module XX', subtitle: '[Onderwerp]', badge: 'Fysica', icon: 'function' },
