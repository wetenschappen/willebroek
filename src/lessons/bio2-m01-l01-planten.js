/**
 * Planten: Bouw & Functies — Biologie 2
 *
...
export default {
    ...
    // ─── 3. GOALS ─────────────────────────────────────────────────────────────
    goals: [
        'Ik kan planten beschrijven.',
        'Ik begrijp hoe planten werkt.',
        'Ik pas planten toe op een nieuw voorbeeld.'
    ],
        ...
        stepA: {
            ...
            cards: [
                { id: 'card-entry', type: 'digital', title: 'Diagnostische Toets',
                  description: 'Wat weet je al over planten?', action: 'entry-ticket', icon: 'PhQuestion' },
    ...
    // ─── 6. ACTIVITIES ────────────────────────────────────────────────────────
    activities: {
        main: { type: 'dragDrop', title: 'Planten: begrippen koppelen' },
        mixedRetrieval: { type: 'mixedRetrieval', title: 'Gemengde Herhaling' }
    },

    // ─── 7. SLIDES ────────────────────────────────────────────────────────────
    slidesA: [
        { layout: 'title', title: 'Planten', subtitle: 'Bouw & Functies', badge: 'Biologie', icon: 'function' },
        { layout: 'steps', title: 'Wat ga je leren?', steps: [
            { icon: 'function', text: 'Ik kan planten beschrijven.' },
            { icon: 'function', text: 'Ik begrijp hoe planten werkt.' }
        ]},
        { layout: 'predict', title: 'Wat weet je al?', question: 'Wat weet je al over planten?',
          hint: 'Denk aan wat je eerder zag.', revealText: 'TODO: antwoord invullen.' }
    ],

    slidesB: [
        { layout: 'definition', term: 'Planten', definition: 'TODO: definitie invullen.' },
    ...
    exitTicket: {
        questions: [
            ...
            { id: 'ex2', type: 'open', question: 'Reflectie',
              description: 'Leg in je eigen woorden uit wat je vandaag leerde over planten.' }
        ]
    }
}
