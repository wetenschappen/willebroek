/**
 * Stoffen & Materialen: Eigenschappen — Chemie 1
 *
...
export default {
    ...
    goals: [
        'Ik kan stoffen & materialen beschrijven.',
        'Ik begrijp hoe stoffen & materialen werkt.'
    ],
    workbook: {
    ...
    activities: {
        main: { type: 'dragDrop', title: 'Stoffen & Materialen: begrippen koppelen' }
    },
    slidesA: [
        { layout: 'title', title: 'Stoffen & Materialen', subtitle: 'Eigenschappen', badge: 'Chemie', icon: 'function' },
        { layout: 'steps', title: 'Wat ga je leren?', steps: [
            { icon: 'function', text: 'Ik kan stoffen & materialen beschrijven.' }
        ]}
    ],
    slidesB: [
        { layout: 'definition', term: 'Stoffen & Materialen', definition: 'TODO' },
