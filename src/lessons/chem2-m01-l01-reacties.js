/**
 * Chemische Reacties: Basis — Chemie 2
 *
...
export default {
    ...
    goals: [
        'Ik kan chemische reacties beschrijven.',
        'Ik begrijp hoe chemische reacties werkt.'
    ],
    workbook: {
    ...
    activities: {
        main: { type: 'dragDrop', title: 'Chemische Reacties: begrippen koppelen' }
    },
    slidesA: [
        { layout: 'title', title: 'Chemische Reacties', subtitle: 'Basis', badge: 'Chemie', icon: 'function' },
        { layout: 'steps', title: 'Wat ga je leren?', steps: [
            { icon: 'function', text: 'Ik kan chemische reacties beschrijven.' }
        ]}
    ],
    slidesB: [
        { layout: 'definition', term: 'Chemische Reacties', definition: 'TODO' },
