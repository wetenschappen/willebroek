/**
 * Krachten: Meten & Eenheden — Fysica 1
 *
...
export default {
    ...
    // ─── 3. GOALS ─────────────────────────────────────────────────────────────
    goals: [
        'Ik kan krachten beschrijven.',
        'Ik begrijp hoe krachten werkt.',
        'Ik pas krachten toe op een nieuw voorbeeld.'
    ],
        ...
        stepA: {
            ...
            cards: [
                { id: 'card-entry', type: 'digital', title: 'Diagnostische Toets',
                  description: 'Wat weet je al over krachten?', action: 'entry-ticket', icon: 'PhQuestion' },
    ...
    // ─── 6. ACTIVITIES ────────────────────────────────────────────────────────
    activities: {
        main: { type: 'springForceLab', title: 'Veerkracht & Uitrekking' },
        mixedRetrieval: { type: 'mixedRetrieval', title: 'Gemengde Herhaling' }
    },

    // ─── 7. SLIDES ────────────────────────────────────────────────────────────
    slidesA: [
        { layout: 'title', title: 'Krachten', subtitle: 'Meten & Eenheden', badge: 'Fysica', icon: 'function' },
        { layout: 'steps', title: 'Wat ga je leren?', steps: [
            { icon: 'function', text: 'Ik kan krachten beschrijven.' },
            { icon: 'function', text: 'Ik begrijp hoe krachten werkt.' }
        ]},
        { layout: 'predict', title: 'Wat weet je al?', question: 'Wat weet je al over krachten?',
          hint: 'Denk aan wat je eerder zag.', revealText: 'TODO: antwoord invullen.' }
    ],

    slidesB: [
        { layout: 'definition', term: 'Krachten', definition: 'TODO: definitie invullen.' },
    ...
    exitTicket: {
        questions: [
            ...
            { id: 'ex2', type: 'open', question: 'Reflectie',
              description: 'Leg in je eigen woorden uit wat je vandaag leerde over krachten.' }
        ]
    }
}
