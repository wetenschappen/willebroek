/**
 * Elektriciteit: Lading & Spanning — Fysica 3
 *
...
export default {
    ...
    // ─── 3. GOALS ─────────────────────────────────────────────────────────────
    goals: [
        'Ik kan elektriciteit beschrijven.',
        'Ik begrijp hoe elektriciteit werkt.',
        'Ik pas elektriciteit toe op een nieuw voorbeeld.'
    ],
        ...
        stepA: {
            ...
            cards: [
                { id: 'card-entry', type: 'digital', title: 'Diagnostische Toets',
                  description: 'Wat weet je al over elektriciteit?', action: 'entry-ticket', icon: 'PhQuestion' },
    ...
    // ─── 6. ACTIVITIES ────────────────────────────────────────────────────────
    activities: {
        main: { type: 'circuits', title: 'Elektrische schakelingen' },
        mixedRetrieval: { type: 'mixedRetrieval', title: 'Gemengde Herhaling' }
    },

    // ─── 7. SLIDES ────────────────────────────────────────────────────────────
    slidesA: [
        { layout: 'title', title: 'Elektriciteit', subtitle: 'Lading & Spanning', badge: 'Fysica', icon: 'function' },
        { layout: 'steps', title: 'Wat ga je leren?', steps: [
            { icon: 'function', text: 'Ik kan elektriciteit beschrijven.' },
            { icon: 'function', text: 'Ik begrijp hoe elektriciteit werkt.' }
        ]},
        { layout: 'predict', title: 'Wat weet je al?', question: 'Wat weet je al over elektriciteit?',
          hint: 'Denk aan wat je eerder zag.', revealText: 'TODO: antwoord invullen.' }
    ],

    slidesB: [
        { layout: 'definition', term: 'Elektriciteit', definition: 'TODO: definitie invullen.' },
    ...
    exitTicket: {
        questions: [
            ...
            { id: 'ex2', type: 'open', question: 'Reflectie',
              description: 'Leg in je eigen woorden uit wat je vandaag leerde over elektriciteit.' }
        ]
    }
}
