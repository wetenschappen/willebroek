...
function checkReflection() {
  ...
  const conceptWords = ["irrationaal", "wortel", "breuk", "pythagoras", "getal", "bewijs", "constructie", "reëel"]
  const reasonWords = ["omdat", "dus", "daarom", "want", "als", "dan", "doordat", "waarom", "omdat"]
              ...
              <div class="p-4 bg-amber-50 border border-amber-200 rounded-xl shadow-sm mb-4">
                ...
                <div class="space-y-2 mb-3">
                  <div v-for="(step, i) in currentLevelData.workedExample.steps" :key="i"
                    ...
                    <span class="w-6 h-6 rounded-full bg-amber-200 text-amber-700 text-xs font-bold flex items-center justify-center shrink-0 mt-0.5">
                      {{ i + 1 }}
                    </span>
            ...
            <div v-if="!showPrediction && !showWorkedExample">
              ...
              <div class="p-4 border border-slate-200 bg-slate-50 rounded-xl shadow-inner flex flex-col gap-4">
                ...
                <div class="font-mono font-black text-xl text-slate-700 bg-white p-4 rounded-lg shadow-sm border-2 border-slate-200 text-center">
                  ...
                  <span class="text-amber-600">√{{ currentC2 }}</span>
                </div>
              ...
              <div class="mt-4 flex flex-col gap-2">
                ...
                <button @click="dropToAxis" v-if="step === 1"
                        class="py-3 px-4 bg-amber-600 text-white font-bold rounded-lg shadow-sm hover:bg-amber-500 active:scale-95 transition-all flex items-center justify-center gap-2 animate-pulse focus-visible:ring-2 focus-visible:ring-amber-500">
