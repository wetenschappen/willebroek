...
const levelTemplates = [
  {
    ...
    items: [
      ...
      { id: 'l4', name: 'Afstand tot de zee', val: 45, correctUnit: 'km', selectedUnit: null, icon: PhCar, color: 'text-amber-500', bg: 'bg-amber-50' }
    ]
  },
  {
    stamps: ['ml', 'cl', 'l', 'm³'],
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'm3', name: 'Volwassen man', val: 80, correctUnit: 'kg', selectedUnit: null, icon: PhUser, color: 'text-amber-500', bg: 'bg-amber-50' },
      ...
      <main class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showWorkedExample" class="bg-amber-50 p-4 rounded-lg mb-4 border-l-4 border-amber-400 animate-fadeIn">
              ...
              <div class="p-2 bg-white rounded-lg text-center font-bold text-amber-700 border border-amber-200">
        ...
        <div class="flex flex-col flex-1 overflow-hidden bg-slate-50">
          <div class="flex flex-col flex-1 p-8 overflow-y-auto items-center justify-center relative pattern-grid">
              ...
              <div v-if="showWorkedExample" class="w-full max-w-3xl bg-white px-10 py-8 rounded-xl shadow-md border-2 border-amber-200 flex items-center justify-center mb-6">
                <div class="text-center">
                  ...
                  <p class="text-lg text-amber-600 mt-2">Welke eenheid kies je?</p>
                </div>
              </div>
                  ...
                  <div v-for="item in currentItems" :key="item.id" class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col items-center animate-fadeIn transform transition-transform">
                      ...
                      <div class="mt-2 flex items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200 w-full justify-center">
                          ...
                          <div @dragover.prevent @drop="onDrop(item)"
                               ...
                               :class="item.selectedUnit ? (isCorrect ? 'border-amber-400 bg-amber-50' : (isChecked && item.selectedUnit !== item.correctUnit ? 'border-red-400 bg-red-50' : 'border-slate-800 bg-slate-100')) : 'border-amber-300 bg-amber-50/50 hover:bg-amber-100'">
