...
function checkReflection() {
  ...
  const conceptWords = ["getallenas", "getal", "positie", "reëel", "dichtheid", "tussen", "groter", "kleiner", "wortel", "irrationaal"]
  const reasonWords = ["omdat", "dus", "daarom", "want", "als", "dan", "doordat", "betekent", "omdat"]
                ...
                <div class="relative z-10 flex gap-8 px-12">
                  <div v-for="(slot, index) in slots" :key="index"
                    ...
                    <div @dragover.prevent
                         ...
                         :class="slot ? (isCorrect ? 'border-emerald-500 bg-amber-50 shadow-[0_0_15px_#10b981]' : 'border-amber-500 bg-white shadow-md') : 'border-dashed border-slate-400 bg-slate-200/50'">
