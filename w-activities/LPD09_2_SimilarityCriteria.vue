      ...
      <main class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <!-- WORKED EXAMPLE -->
            <div v-if="showWorkedExample" class="p-4 border border-amber-200 bg-amber-50 rounded-xl mb-4 animate-fadeIn">
            ...
            <!-- PREDICTION GATE -->
            <div v-if="showPrediction && !showWorkedExample" class="p-5 border-2 border-amber-300 bg-amber-50 rounded-xl mb-4 animate-fadeIn">
            ...
            <div v-if="!showPrediction && !showWorkedExample && !isCorrect" class="mt-4 space-y-4">
            ...
            <div v-if="!showPrediction && !showWorkedExample" class="mt-4">
