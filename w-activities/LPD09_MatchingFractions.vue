...
function checkReflection() {
  ...
  const conceptWords = ['deel', 'delen', 'noemer', 'teller', 'procent', 'honderd']
  ...
  if ((conceptWords.some(w => ans.includes(w)) || ans.length > 15) && 
    ...
    feedback.value = { type: 'info', text: 'Gebruik conceptwoorden (teller, noemer, procent) en leg uit waarom.' }
  }
}
      ...
      <main class="flex flex-1 overflow-hidden">
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="phase === 'match' && !isCorrect" class="p-4 border border-slate-200 bg-slate-50 rounded-xl shadow-inner animate-fadeIn">
            ...
            <div v-if="showReflection" class="mt-4 p-4 border border-amber-200 bg-amber-50 rounded-xl animate-fadeIn">
              ...
              <p class="text-sm text-slate-600 mb-3">Waarom is het handig om breuken ook als procenten of decimalen te kunnen opschrijven?</p>
          ...
          <div class="p-6 bg-slate-50 border-t border-slate-200 shrink-0">
            ...
            <div class="flex items-center gap-4">
              ...
              <!-- Next after correct -->
              <button v-if="isCorrect && phase === 'match'" @click="proceedToReflection"
