          ...
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showWorkedExample" class="bg-amber-50 p-4 rounded-lg mb-4 border-l-4 border-amber-400 animate-fadeIn">
              ...
              <div class="space-y-1 text-sm text-slate-700 mb-2">
                <div class="flex items-start gap-2"><span class="text-amber-500 font-bold shrink-0">1.</span><span>SOS CAS TOA: S = O / S → sinus gebruikt Overstaand en Schuin.</span></div>
                <div class="flex items-start gap-2"><span class="text-amber-500 font-bold shrink-0">2.</span><span>Bij hoek \u03b1 (linksonder) is de overstaande zijde de verticale, de schuine de diagonaal.</span></div>
                <div class="flex items-start gap-2"><span class="text-amber-500 font-bold shrink-0">3.</span><span>Antwoord: sinus = overstaande / schuine zijde.</span></div>
              </div>
