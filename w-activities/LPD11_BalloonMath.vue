          ...
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showWorkedExample && currentInternalLevel === 0"
              ...
              <div class="flex items-center gap-2 mb-3">
                ...
                <h4 class="font-bold text-amber-800">Voorbeeld: balloncontext</h4>
              </div>
              <div class="space-y-1">
                  ...
                  <div>
                    <div class="p-2 border-2 border-dashed rounded-lg"
                         :class="labelSlots.height
                           ? (labelSlots.height === 'O' ? 'border-amber-400 bg-amber-50' : 'border-red-400 bg-red-50')
                  ...
                  <div>
                    <div class="p-2 border-2 border-dashed rounded-lg"
                         :class="labelSlots.ground
                           ? (labelSlots.ground === 'A' ? 'border-amber-400 bg-amber-50' : 'border-red-400 bg-red-50')
                           : 'border-slate-300 bg-white'">
                  ...
                  <div>
                    <div class="p-2 border-2 border-dashed rounded-lg"
                         :class="labelSlots.string
                           ? (labelSlots.string === 'H' ? 'border-amber-400 bg-amber-50' : 'border-red-400 bg-red-50')
                           : 'border-slate-300 bg-white'">
          ...
          <div class="flex flex-col flex-1 p-6 overflow-y-auto">
            ...
            <div class="relative flex-1 flex items-center justify-center w-full min-h-[400px] p-8 bg-gradient-to-b from-sky-200 to-sky-50 rounded-xl border-2 border-sky-300 pattern-clouds overflow-hidden">
              ...
              <div v-if="currentLevelData" class="relative w-[350px] h-[400px]">
                ...
                <div class="absolute bottom-0 left-0 right-0 h-16 bg-amber-600 rounded-t-3xl border-t-4 border-emerald-800">
                  <div class="absolute inset-0 bg-amber-500/30 rounded-t-3xl"></div>
                  <!-- Grass texture -->
                ...
                <div v-if="currentLevelData.mode === 'identify'"
                  ...
                  <div class="w-full h-full"
                       :class="sideChoice === 'ground' ? 'bg-amber-400' : 'bg-amber-500/60'">
                  </div>
                </div>
                ...
                <div v-if="currentLevelData.mode === 'drag' && !isCorrect"
                     ...
                     :class="labelSlots.height
                       ? (labelSlots.height === 'O' ? 'border-amber-400 bg-amber-50/50' : 'border-red-400 bg-red-50/50')
                ...
                <div v-if="currentLevelData.mode === 'drag' && !isCorrect"
                     ...
                     class="absolute border-3 border-dashed rounded-xl flex items-center justify-center cursor-pointer z-20"
                     :class="labelSlots.ground
                       ? (labelSlots.ground === 'A' ? 'border-amber-400 bg-amber-50/50' : 'border-red-400 bg-red-50/50')
                       : 'border-amber-400 bg-white/40 hover:bg-white/60'"
                ...
                <div v-if="currentLevelData.mode === 'drag' && !isCorrect"
                     ...
                     class="absolute border-3 border-dashed rounded-xl flex items-center justify-center cursor-pointer z-20"
                     :class="labelSlots.string
                       ? (labelSlots.string === 'H' ? 'border-amber-400 bg-amber-50/50' : 'border-red-400 bg-red-50/50')
                       : 'border-amber-400 bg-white/40 hover:bg-white/60'"
                ...
                <div v-if="isCorrect" class="absolute inset-0 z-30 pointer-events-none">
                  <div class="absolute bg-emerald-400/20 rounded-lg border-2 border-amber-400"
            ...
            <div v-if="currentLevelData"
              ...
              <div class="flex justify-center gap-6 text-sm">
                ...
                <div class="text-center">
                  <p class="font-bold text-amber-600 tabular-nums">{{ currentLevelData.groundDist }} m</p>
