  ...
  <div class="relative flex w-full max-w-6xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden">
    ...
    <div v-if="showPredictionGate && !predictionMade" class="absolute inset-0 z-20 bg-white overflow-y-auto p-8">
      <div class="max-w-xl mx-auto text-center">
        <div class="p-3 rounded-full bg-amber-100 w-16 h-16 flex items-center justify-center mx-auto mb-4">
          <PhTarget class="w-8 h-8 text-amber-600" weight="fill" />
        </div>
        ...
        <div class="flex flex-col gap-3">
          <button @click="handlePrediction('snijdend-evenwijdig-kruisend')" class="p-4 border-2 border-amber-200 rounded-xl hover:bg-amber-50 hover:border-amber-400 font-bold text-slate-700 transition-all">Snijdend, evenwijdig, kruisend</button>
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 md:flex z-10">
          ...
          <div class="p-6 bg-slate-50 border-t border-slate-200 shrink-0">
            ...
            <div v-if="showReflection && !reflectionDone" class="p-4 mb-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              <h4 class="font-bold text-amber-800 mb-3 text-sm">Reflectie: Denk dieper na</h4>
              <p class="text-sm text-amber-700 mb-3"><strong>Waarom</strong> is het belangrijk om het verschil tussen kruisende en evenwijdige lijnen te kennen in de ruimtemeetkunde? Wat zou er fout gaan als je deze twee door elkaar haalt bij het berekenen van afstanden?</p>
            ...
            <div class="flex items-center gap-4">
              ...
              <button v-else @click="handleNext" class="flex items-center justify-center flex-1 gap-2 py-4 font-bold text-white transition-all rounded-lg shadow-md bg-amber-600 hover:bg-amber-500 active:scale-[0.98] animate-fadeIn">
