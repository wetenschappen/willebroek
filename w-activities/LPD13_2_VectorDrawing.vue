    ...
    <div v-if="showPredictionGate&&!predictionMade" class="absolute inset-0 z-20 bg-white overflow-y-auto p-8">
      <div class="max-w-xl mx-auto text-center">
        ...
        <div class="flex flex-col gap-3">
          <button @click="handlePrediction('componenten')" class="p-4 border-2 border-amber-200 rounded-xl hover:bg-amber-50 hover:border-amber-400 font-bold text-slate-700 transition-all">Tel de x- en y-componenten apart op</button>
          ...
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="p-6 border border-slate-200 bg-slate-50 rounded-xl space-y-4 shadow-inner">
              ...
              <ul class="text-lg font-mono font-bold text-slate-700 space-y-4">
                ...
                <li v-if="currentLevelData.vecB" class="flex items-center gap-2"><span class="inline-block w-4 h-4 bg-amber-500 rounded-lg"></span>b = ({{ currentLevelData.vecB.x }}, {{ currentLevelData.vecB.y }})</li>
            ...
            <div v-if="showReflection&&!reflectionDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-sm text-amber-700 mb-3"><strong>Waarom</strong> is het handig dat vectoren in componenten worden uitgedrukt? Hoe zou je anders de som bepalen?</p>
            ...
            <div v-if="showLPDEvidence&&!lpdDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              <h4 class="font-bold text-amber-800 mb-3 text-sm">LPD 13: Bewijs van beheersing</h4>
              <p class="text-sm text-amber-700 mb-3">Je hebt bewezen dat je vectoren kan tekenen in een assenstelsel. Vul aan: "Om de som a + b te tekenen, tel ik de _____ apart op en teken ik de vector van de _____ naar het nieuwe punt."</p>
