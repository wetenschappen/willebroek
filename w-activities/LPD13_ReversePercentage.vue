        ...
        <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
          ...
          <details class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <div class="mt-3 text-sm space-y-2">
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> Na 25% korting kost een jas €60. Wat was de oorspronkelijke prijs?</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> 100% - 25% = 75% = €60. 75% = 3 blokjes van 25%.</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> 1 blokje (25%) = €60 ÷ 3 = €20.</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> Originele prijs (100%) = 4 × €20 = €80.</p>
            </div>
          </details>
          ...
          <div v-if="!predictionMade" class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <p class="text-xs text-amber-600 mb-3">Hoe ga je de originele prijs vinden?</p>
            <div class="space-y-2">
