    ...
    <div v-if="showPredictionGate&&!predictionMade" class="absolute inset-0 z-20 bg-white overflow-y-auto p-8">
      <div class="max-w-xl mx-auto text-center">
        ...
        <div class="flex flex-col gap-3">
          <button @click="handlePrediction('pythagoras')" class="p-4 border-2 border-amber-200 rounded-xl hover:bg-amber-50 hover:border-amber-400 font-bold text-slate-700 transition-all">Stelling van Pythagoras</button>
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showWhySection" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700">De norm van een vector is de afstand van de oorsprong tot het punt (x,y). Deze afstand bereken je met Pythagoras omdat de x- en y-as loodrecht op elkaar staan. De vector is de schuine zijde van een rechthoekige driehoek met rechthoekszijden x en y.</p>
            </div>
            ...
            <div v-if="showReflection&&!reflectionDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700 mb-3"><strong>Waarom</strong> is de norm altijd positief? Wat stelt de norm fysisch voor?</p>
            ...
            <div v-if="showLPDEvidence&&!lpdDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              <h4 class="font-bold text-amber-800 mb-3 text-sm">LPD 14: Bewijs van beheersing</h4>
              <p class="text-xs text-amber-700 mb-3">Je hebt bewezen dat je vectoren kan tekenen met een gegeven norm. Vul aan: "De norm van vector (x,y) is ||v|| = ____. Dit is eigenlijk de ____ van de oorsprong naar het punt (x,y)."</p>
