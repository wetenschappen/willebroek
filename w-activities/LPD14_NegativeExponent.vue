        ...
        <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
          ...
          <details class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <div class="mt-3 text-sm space-y-2">
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> 2^3 = 2 × 2 × 2 = 8 (vermenigvuldigen).</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> 2^(-3) = 1 ÷ 2 ÷ 2 ÷ 2 = 1/8 (delen).</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> Dus 2^(-3) = 1 / 2^3 = 1/8.</p>
            </div>
          </details>
          ...
          <div v-if="!predictionMade" class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <p class="text-xs text-amber-600 mb-3">Wat denk je dat een negatieve exponent geeft?</p>
            <div class="space-y-2">
            ...
            <div class="mt-12 bg-slate-200 p-6 rounded-xl flex items-center gap-8 shadow-inner w-full max-w-sm">
              ...
              <div class="flex-1 flex flex-col items-center">
                ...
                <div class="flex items-center bg-white rounded-lg shadow-sm border border-slate-300 overflow-hidden w-full">
                  ...
                  <div class="flex-1 text-center font-black text-2xl tabular-nums" :class="exponent < 0 ? 'text-amber-500' : (exponent > 0 ? 'text-amber-600' : 'text-slate-700')">{{ exponent }}</div>
