        ...
        <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
          ...
          <details class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <div class="mt-3 text-sm space-y-2">
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> Rekenmachine zegt: 72 × 8 = 5760. Klopt dat?</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> Rond af: 72 ≈ 70, 8 blijft 8. Schatting: 70 × 8 = 560.</p>
              <p class="flex items-center gap-2"><PhCheckCircle weight="bold" class="w-4 h-4 text-amber-500 shrink-0" /> 5760 is véél groter dan 560. ONZIN! Het juiste antwoord is 576.</p>
            </div>
          </details>
          ...
          <div v-if="!predictionMade" class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-4">
            ...
            <p class="text-xs text-amber-600 mb-3">Wat denk je van het rekenmachine-antwoord?</p>
            <div class="space-y-2">
              ...
              <div>
                ...
                <div class="flex gap-2 mt-1">
                  <button @click="userVerdict = 'correct'" :disabled="isCorrect"
                    ...
                    :class="userVerdict === 'correct' ? 'bg-amber-500 border-emerald-600 text-white' : 'bg-white border-slate-300 text-slate-600'">KLOPT</button>
