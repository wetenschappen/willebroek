          ...
          <div v-if="showWorkedExample" class="bg-amber-50 p-4 rounded-lg mb-4 border-l-4 border-amber-400 animate-fadeIn">
            ...
            <div class="bg-white border border-amber-200 rounded p-2 mb-2 text-xs">
              <table class="w-full text-center border-collapse">
                ...
                <tr><td class="border border-slate-200 p-1 font-bold">f(x)</td><td class="border border-slate-200 p-1 text-red-600">−</td><td class="border border-slate-200 p-1 font-bold">0</td><td class="border border-slate-200 p-1 text-amber-600">+</td></tr>
              </table>
            </div>
