...
function checkAnswer() {
  ...
  if (parsed === currentLevelData.value.answer) {
    ...
    showWhy.value = true
    whyText.value = getWhyExplanation()
    const d = currentLevelData.value
    feedback.value = {
      type: 'success',
      ...
      <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 shadow-inner-light md:flex z-10">
        <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
          ...
          <div v-if="showReflection" class="mt-4 p-4 bg-indigo-50 border border-indigo-200 rounded-xl animate-fadeIn">
            ...
            <p class="text-xs text-indigo-600 mb-2">Waarom is de substitutiemethode beter dan grafisch oplossen als de oplossing breuken bevat?</p>
