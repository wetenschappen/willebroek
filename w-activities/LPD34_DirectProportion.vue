            ...
            <div v-if="showWorkedExample" class="bg-amber-50 p-4 rounded-lg mb-4 border-l-4 border-amber-400 animate-fadeIn">
              ...
              <div class="overflow-x-auto mb-2">
                <table class="w-full text-sm border-collapse bg-white rounded">
                  <thead><tr class="bg-amber-100"><th class="p-1 border">Tijd (h)</th><th class="p-1 border">Afstand (km)</th></tr></thead>
                  <tbody>
              ...
              <table class="w-full text-center border-collapse bg-white rounded-lg overflow-hidden shadow-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="p-1 border"><input type="number" v-model.number="ans2" :disabled="isCorrect" class="w-full p-1 text-center font-bold border-b-2 focus:border-amber-500 outline-none tabular-nums" :class="ans2 === (currentLevel ? currentLevel.answers.ans2 : null) && isChecked ? 'border-emerald-500 text-amber-600' : 'border-slate-300'" /></td>
                  </tr>
                  <tr>
                    <td class="p-2 border font-bold">4</td>
                    <td class="p-1 border"><input type="number" v-model.number="ans4" :disabled="isCorrect" class="w-full p-1 text-center font-bold border-b-2 focus:border-amber-500 outline-none tabular-nums" :class="ans4 === (currentLevel ? currentLevel.answers.ans4 : null) && isChecked ? 'border-emerald-500 text-amber-600' : 'border-slate-300'" /></td>
                  </tr>
                  <tr>
                    <td class="p-2 border font-bold">5</td>
                    <td class="p-1 border"><input type="number" v-model.number="ans5" :disabled="isCorrect" class="w-full p-1 text-center font-bold border-b-2 focus:border-amber-500 outline-none tabular-nums" :class="ans5 === (currentLevel ? currentLevel.answers.ans5 : null) && isChecked ? 'border-emerald-500 text-amber-600' : 'border-slate-300'" /></td>
                  </tr>
                </tbody>
              </table>
            </div>
