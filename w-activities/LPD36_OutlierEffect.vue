  ...
  if (userAns.value === 'mean') {
    ...
    if (attemptCount.value < 3) {
      ...
      if (userAns.value === 'median') {
        errorDetected.value = "Je koos de mediaan, maar kijk eens goed naar de verandering."
        ...
        errorDetected.value = "Je koos beide, maar ze veranderen niet evenveel."
        ...
        errorDetected.value = "Kies het juiste antwoord."
      ...
      errorDetected.value = "Het juiste antwoord is het gemiddelde."
      feedback.value = {
        type: 'error',
  ...
  if (Math.abs(val - expected) <= 0.5) {
    ...
    if (attemptCount.value < 3) {
      ...
      if (Math.abs(val - asMeanOf6) <= 0.5) {
        errorDetected.value = "Je hebt door het verkeerde aantal gedeeld."
        feedback.value = {
          type: 'error',
        ...
        errorDetected.value = "Je berekening klopt niet."
        feedback.value = {
          type: 'error',
      ...
      errorDetected.value = `Het juiste antwoord is ${currentLevel.value.meanWithout}.`
      feedback.value = {
        type: 'error',
...
function checkReflection() {
  ...
  if (reflectionAnswer.value.trim().length < 5) {
    attemptCount.value++
    errorDetected.value = "Je antwoord is te kort."
