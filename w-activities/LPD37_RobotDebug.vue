    ...
    <div v-if="showPredictionGate&&!predictionMade" class="absolute inset-0 z-20 bg-white overflow-y-auto p-8">
      <div class="max-w-xl mx-auto text-center">
        ...
        <div class="flex flex-col gap-3">
          <button @click="handlePrediction('up')" class="p-4 border-2 border-amber-200 rounded-xl hover:bg-amber-50 hover:border-amber-400 font-bold text-slate-700 transition-all">Omhoog (want naar rechts is geblokkeerd)</button>
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showReflection&&!reflectionDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700 mb-3"><strong>Waarom</strong> is het belangrijk om een algoritme stap voor stap te testen? Wat gebeurt er als je een fout over het hoofd ziet?</p>
            ...
            <div v-if="showLPDEvidence&&!lpdDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700 mb-3">Je hebt een algoritme ontworpen, getest en gedebugd. Vul aan: "Ik ontwerp een algoritme door eerst te _____, dan de stappen in _____ om te zetten, te testen, en te _____ als het fout gaat."</p>
              ...
              <div class="absolute inset-2 grid grid-cols-4 grid-rows-4 gap-1 z-0">
                <template v-for="y in 4" :key="'ry'+y"><template v-for="x in 4" :key="'rx'+x">
                  <div class="bg-slate-100 rounded-lg relative flex items-center justify-center">
                    <div v-if="x-1===goalX&&4-y===goalY" class="absolute inset-1 bg-amber-500/30 rounded-lg border-2 border-emerald-500 animate-pulse"></div>
