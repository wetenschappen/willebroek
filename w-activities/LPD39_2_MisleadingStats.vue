...
const levelLabels = ['Herinneren', 'Begrijpen', 'Toepassen', 'Analyseren', 'Evalueren', 'Creëren']

const Bloom = computed(() => {
  const labels = ['Herinneren', 'Begrijpen', 'Toepassen', 'Analyseren', 'Evalueren', 'Creëren']
...
function selectAnswer(answer) {
  ...
  if (answer === currentLevel.value.correctAnswer) {
    ...
    if (attemptCount.value < 3) {
      errorDetected.value = "Dit is niet het juiste antwoord."
      ...
      errorDetected.value = "Het antwoord is: Ja, dit is misleidend."
