    ...
    <div v-if="showPredictionGate&&!predictionMade" class="absolute inset-0 z-20 bg-white overflow-y-auto p-8">
      <div class="max-w-xl mx-auto text-center">
        ...
        <div class="flex flex-col gap-3">
          <button @click="handlePrediction('ja')" class="p-4 border-2 border-amber-200 rounded-xl hover:bg-amber-50 hover:border-amber-400 font-bold text-slate-700 transition-all">Ja, want er zijn 2 oneven knopen</button>
        ...
        <div class="flex-col hidden w-full max-w-sm bg-white border-r border-slate-200 md:flex z-10">
          <div ref="mainArea" tabindex="-1" class="flex-1 p-6 overflow-y-auto">
            ...
            <div v-if="showWhySection" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700">De stelling van Euler is een van de oudste stellingen uit de grafentheorie (1736). Ze zegt dat een graaf een Eulerpad heeft als er 0 of 2 knopen met oneven graad zijn. Een oneven graad betekent dat je de knoop evenveel keer moet verlaten als binnenkomen — bij oneven graad lukt dat niet tenzij je daar start of eindigt.</p>
            </div>
            ...
            <div v-if="showReflection&&!reflectionDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              ...
              <p class="text-xs text-amber-700 mb-3"><strong>Waarom</strong> is de stelling van Euler nuttig voor praktische problemen zoals postbedeling, sneeuwruimen of bridgen?</p>
            ...
            <div v-if="showLPDEvidence&&!lpdDone" class="p-4 mt-4 bg-amber-50 border border-amber-200 rounded-xl animate-fadeIn">
              <h4 class="font-bold text-amber-800 mb-3 text-sm">LPD K3: Bewijs van beheersing</h4>
              <p class="text-xs text-amber-700 mb-3">Je hebt bewezen dat je Eulerpaden kan toepassen op reele problemen. Vul aan: "Een graaf heeft een Eulerpad als het aantal knopen met _____ graad _____ of _____ is. Dit gebruik ik om problemen op te lossen zoals _____."</p>
